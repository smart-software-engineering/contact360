defmodule Contact360Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Contact360Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Contact360Web.Gettext, "errors", msg, opts)
    end
  end
